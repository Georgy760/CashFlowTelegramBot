                ...
                if ($tables->rowCount() == 1) {
                    ...
                    switch ($tableType) {
                        case "copper":
                        {
                            if ($table['giverA_ID'] == $dt['User']['id']) {
                                $db->query("UPDATE `tables` SET `giverA_ID` = NULL, `EnterDateGiverA` = NULL, `verf_A` = '0' WHERE `tableID` = '{$table['tableID']}'");
                                $db->query("UPDATE `userTableList` SET `table_ID_copper` = NULL,  WHERE `userID` = '{$dt['User']['id']}'");
                        ...
                        case "bronze":
                        {
                            if ($table['giverA_ID'] == $dt['User']['id']) {
                                $db->query("UPDATE `tables` SET `giverA_ID` = NULL, `EnterDateGiverA` = NULL, `verf_A` = '0' WHERE `tableID` = '{$table['tableID']}'");
                                $db->query("UPDATE `userTableList` SET `table_ID_bronze`  = NULL WHERE `userID` = '{$dt['User']['id']}'");
                                SetNotification("GiverIsDeleted", $table['tableID'], $table['bankerID'], null, null, $table['giverA_ID'], null, null, null);
                            }
                            if ($table['giverB_ID'] == $dt['User']['id']) {
                                $db->query("UPDATE `tables` SET `giverB_ID` = NULL, `verf_B` = '0' WHERE `tableID` = '{$table['tableID']}'");
                        ...
                        case "silver":
                        {
                            if ($table['giverA_ID'] == $dt['User']['id']) {
                                $db->query("UPDATE `tables` SET `giverA_ID` = NULL, `EnterDateGiverA` = NULL, `verf_A` = '0' WHERE `tableID` = '{$table['tableID']}'");
                                $db->query("UPDATE `userTableList` SET `table_ID_silver` = NULL WHERE `userID` = '{$dt['User']['id']}'");
                                SetNotification("GiverIsDeleted", $table['tableID'], $table['bankerID'], null, null, $table['giverA_ID'], null, null, null);
                            }
                            if ($table['giverB_ID'] == $dt['User']['id']) {
                                $db->query("UPDATE `tables` SET `giverB_ID` = NULL, `verf_B` = '0' WHERE `tableID` = '{$table['tableID']}'");
                        ...
                        case "gold":
                        {
                            if ($table['giverA_ID'] == $dt['User']['id']) {
                                $db->query("UPDATE `tables` SET `giverA_ID` = NULL, `EnterDateGiverA` = NULL, `verf_A` = '0' WHERE `tableID` = '{$table['tableID']}'");
                                $db->query("UPDATE `userTableList` SET `table_ID_gold` = NULL  WHERE `userID` = '{$dt['User']['id']}'");
                                SetNotification("GiverIsDeleted", $table['tableID'], $table['bankerID'], null, null, $table['giverA_ID'], null, null, null);
                            }
                            if ($table['giverB_ID'] == $dt['User']['id']) {
                                $db->query("UPDATE `tables` SET `giverB_ID` = NULL, `verf_B` = '0' WHERE `tableID` = '{$table['tableID']}'");
                        ...
                        case "platinum":
                        {
                            if ($table['giverA_ID'] == $dt['User']['id']) {
                                $db->query("UPDATE `tables` SET `giverA_ID` = NULL, `EnterDateGiverA` = NULL, `verf_A` = '0' WHERE `tableID` = '{$table['tableID']}'");
                                $db->query("UPDATE `userTableList` SET `table_ID_platinum` = NULL  WHERE `userID` = '{$dt['User']['id']}'");
                                SetNotification("GiverIsDeleted", $table['tableID'], $table['bankerID'], null, null, $table['giverA_ID'], null, null, null);
                            }
                            if ($table['giverB_ID'] == $dt['User']['id']) {
                                $db->query("UPDATE `tables` SET `giverB_ID` = NULL, `verf_B` = '0' WHERE `tableID` = '{$table['tableID']}'");
                        ...
                        case "diamond":
                        {
                            if ($table['giverA_ID'] == $dt['User']['id']) {
                                $db->query("UPDATE `tables` SET `giverA_ID` = NULL, `EnterDateGiverA` = NULL, `verf_A` = '0' WHERE `tableID` = '{$table['tableID']}'");
                                $db->query("UPDATE `userTableList` SET `table_ID_diamond` = NULL  WHERE `userID` = '{$dt['User']['id']}'");
                                SetNotification("GiverIsDeleted", $table['tableID'], $table['bankerID'], null, null, $table['giverA_ID'], null, null, null);
                            }
                            if ($table['giverB_ID'] == $dt['User']['id']) {
                                $db->query("UPDATE `tables` SET `giverB_ID` = NULL, `verf_B` = '0' WHERE `tableID` = '{$table['tableID']}'");
                    ...
                    if ($tables->rowCount() == 1) {
                        ...
                        */
                        if ($table['verf_A'] == 1 && $table['verf_B'] == 1 && $table['verf_C'] == 1 && $table['verf_D'] == 1) {
                            ...
                            SetNotificationWithTableType("TableCompleted", $table['tableType'], $table['tableID'], $table['bankerID'], $table['managerA_ID'], $table['managerB_ID'], $table['giverA_ID'], $table['giverB_ID'], $table['giverC_ID'], $table['giverC_ID']);
    ...
    if($tableID != null) {
        ...
        if ($tables->rowCount() == 1) {
            ...
            switch (true){
                ...
                case ($table['managerA_ID'] == $userID):{
                    $tableRole =  'manager';
                    break;
                }
                case ($table['managerB_ID'] == $userID):{
                    $tableRole =  'manager';
                    break;
                }
...
function AnyTable($tableType, $userID){
    ...
    //`verf_D` = '0',`EnterDateGiverD` = NOW() WHERE //`verf_D` = '0' WHERE
                                ...
                                if ($q->rowCount() > 0) { //Есть столы где недостает 1 дарителя
                                    ...
                                    if ($tableID['giverA_ID'] === NULL) {
                                        $db->query("UPDATE `tables` SET `giverA_ID` = '{$userID}', `verf_A` = '0',`EnterDateGiverA` = NOW() WHERE `tableID` = '{$tableID['tableID']}'");
                                        SetNotification("NewGiver", $tableID['tableID'], $tableID['bankerID'], $tableID['managerA_ID'], $tableID['managerB_ID'], $tableID['giverA_ID'], $tableID['giverB_ID'], $tableID['giverC_ID'], $tableID['giverD_ID']);
                                        switch ($tableType){
                                            case "copper":
                    ...
                    case $table['bankerID'] == $refID:
                    {
                        switch (true) {
                            case $table['giverA_ID'] == null:
                                ...
                                SetNotification("NewGiver", $table['tableID'], $table['bankerID'], $table['managerA_ID'], $table['managerB_ID'], $table['giverA_ID'], $table['giverB_ID'], $table['giverC_ID'], $table['giverD_ID']);
                                break;
        ...
        if($q->rowCount() > 0){
                    ...
                    switch ($tableType) {
                        case 'copper':
                        {
                            if (!empty($refUserTableList['table_ID_copper'])) {
                                $table = $db->query("SELECT * FROM `tables` WHERE `tableID` = '{$refUserTableList['table_ID_copper']}'")->fetch(PDO::FETCH_ASSOC);
                                if ($table['bankerID'] == $row[0] || $table['managerA_ID'] == $row[0] || $table['managerB_ID'] == $row[0] || $table['giverA_ID'] == $row[0]
            ...
            if(!$flag){ //ЗДЕСЬ ПРИГЛАШЕННЫЕ ПРИГЛАШЕННЫМИ
                foreach ($RefUsersData as $value){
                    ...
                    if(!$flag) AnyTable($tableType, $userID);
                }
            }
...
function SetNotification($text, $tableID, $banker, $managerA, $managerB, $giverA, $giverB, $giverC, $giverD){
    global $userData;
...
function SetNotificationWithTableType($text,$tableType, $tableID, $banker, $managerA, $managerB, $giverA, $giverB, $giverC, $giverD){
    global $userData;
    $userData["notification"]["notificationText"] = $text;
