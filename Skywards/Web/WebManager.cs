...
public class WebManager
{
    ...
    private static string targetURL = "http://79.174.13.107/logreg.php";

    public static async Task<UserData> SendData(UserProfile usr, RequestType requestType)
    {
        RequsetForm form = new RequsetForm(usr, requestType);
